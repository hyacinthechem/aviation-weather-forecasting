...
from notebooks.training.training_lstm import LSTMWeather, lstm_weather_vsby, lstm_weather_wind, lstm_weather_temp, x_test_processed_wind, y_test_processed_wind, \
    x_test_processed_vsby, y_test_processed_vsby, x_test_processed_temp, y_test_processed_temp, lstm_weather_wind
...
labels = ['lstm-Wind', 'lstm-Visibility', 'lstm-Temperature'][:n_metrics]
